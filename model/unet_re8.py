...
class Unet:
    def __init__(self, shape):
        ...
        self.mmse_dense = layers.Dense(1, activation='sigmoid')(self.mmse)
        ...
        self.model = keras.Model(input=[self.inputs, mmse_input, sex_input, age_input, marriage_input,
                                        apoe4_input, edu_input], output=[self.pure_dense, self.mmse_dense,
                                                                         self.cli_judge, self.dense])
...
if __name__ == '__main__':
    ...
    model.summary()
    plot_model(model, "../img/unet_re8.png", True)
