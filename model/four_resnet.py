...
class Resnet:
    def __init__(self, shape):
        ...
        self.b_block0 = layers.Conv3D(8, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block1 = layers.Conv3D(8, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block2 = layers.Conv3D(8, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block2 = layers.BatchNormalization()(self.b_block2)
        self.b_block2 = layers.Conv3D(16, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
                                      padding='same')(self.b_block2)
        self.b_block2 = layers.BatchNormalization()(self.b_block2)
        ...
        self.b_block3 = layers.Conv3D(16, (1, 1,1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block4 = layers.Conv3D(16, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block5 = layers.Conv3D(32, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block6 = layers.Conv3D(32, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_block7 = layers.Conv3D(32, (1, 1, 1), activation='relu',
                                      kernel_regularizer=regularizers.l2(self.re_rate),
