...
class Unet:
    def __init__(self, shape):
        ...
        self.f_block = layers.Conv3D(4, (3, 1, 1), activation='relu',
                                     kernel_regularizer=regularizers.l2(self.re_rate))(self.inputs)
        ...
        self.b_back2 = layers.Conv3D(16, (3, 3, 3), activation='relu',
                                     kernel_regularizer=regularizers.l2(self.re_rate),
        ...
        self.b_back1 = layers.Conv3D(16, (3, 3, 3), activation='relu',
                                     kernel_regularizer=regularizers.l2(self.re_rate),
...
if __name__ == '__main__':
    model = Unet((50, 168, 152, 1)).get_model()
    model.summary()
