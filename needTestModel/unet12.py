...
class Unet:
    def __init__(self, shape):
        ...
        self.cat = layers.concatenate([self.bn2, self.b_back2])

        self.b_back1 = layers.Conv3D(32, (3, 3, 3), activation='relu',
                                     kernel_regularizer=regularizers.l2(self.re_rate),
                                     padding='same')(layers.UpSampling3D((2, 2, 2))(self.cat))
...
if __name__ == '__main__':
    ...
    model.summary()
    plot_model(model, r"C:\Users\fan\Desktop\model12.png", True)
